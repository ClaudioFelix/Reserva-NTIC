...
public class TipoRecurso{
	...
	public String toString() {
		return "TipoRecurso [codigoTipoRecurso=" + codigoTipoRecurso + ", nomeTipoRecurso=" + nomeTipoRecurso + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + (int) (codigoTipoRecurso ^ (codigoTipoRecurso >>> 32));
	...
	public boolean equals(Object obj) {
		...
		if (codigoTipoRecurso != other.codigoTipoRecurso)
			return false;
		if (nomeTipoRecurso != other.nomeTipoRecurso)
			return false;
		return true;
	}   
}
